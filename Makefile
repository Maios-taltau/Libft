...
#    Updated: 2023/05/03 21:02:53 by skaewpan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_strlen.c ft_strlcpy.c ft_strncmp.c ft_strnstr.c ft_strrchr.c \
	   ft_tolower.c ft_toupper.c ft_substr.c ft_strjoin.c ft_split.c\
